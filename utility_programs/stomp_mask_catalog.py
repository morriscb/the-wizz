...
"""
Utility program for taking an input fits catalog with RA and DEC and masking
the objects to the input stomp map geometry. This is useful for getting the
